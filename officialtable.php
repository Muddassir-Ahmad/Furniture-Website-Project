...
<head>
    ...
    <title>Official Table Collections - Ittadi Furniture</title>
...
<body>
    ...
    <main class="container mt-4">
        ...
        <h3 class="mb-4 text-center">Official Table Collections</h3>
        <div class="row">
            <?php
            $allData = mysqli_query($conn, "SELECT office.*, office_images.image_path
                                            FROM office LEFT JOIN office_images ON office.id = office_images.furniture_id WHERE office.type IN ('Executive Table', 'Senior Ex Table', 'Side Table');");
