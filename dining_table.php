...
<head>
    ...
    <title>Dining Table Collections - Ittadi Furniture</title>
...
<body>
    ...
    <main class="container mt-0">
        ...
        <h3 class="mb-4 text-center">Dining Table Collections</h3>
        <div class="row">
            <?php
            $allData = mysqli_query($conn, "SELECT dinning.*, dinning_images.image_path
                                            FROM dinning
                                            LEFT JOIN dinning_images ON dinning.id = dinning_images.furniture_id
                                            WHERE dinning.type='Dining Table'");
            ...
            ?>
                ...
                <div class="col-6 col-md-3 mb-4">
                    <div class="card">
                        <a href="product_details.php?type=dinning&id=<?php echo $product['id']; ?>">
