      ...
      <div class="col-lg-10 col-md-12">
        ...
        <div class="container mt-3 mb-5">
          <div class="upload-section">
            ...
            <form action="bedroomAction.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="furnitureType" name="furnitureType" required>
                  ...
                  <option value="Alna & Hanger">Alna & Hanger</option>
                  <option value="Easy & smart stool">Easy & smart stool</option>
                </select>
              </div>
              <div class="form-group">
