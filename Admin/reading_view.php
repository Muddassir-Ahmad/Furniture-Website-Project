                ...
                <div class="container mt-4 mb-5">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT reading.id, reading.name, reading.code, reading.price, reading.type, MIN(reading_images.image_path) AS image_path
                            FROM reading
                            LEFT JOIN reading_images ON reading.id = reading_images.furniture_id
                            GROUP BY reading.id, reading.name, reading.code, reading.price, reading.type";
