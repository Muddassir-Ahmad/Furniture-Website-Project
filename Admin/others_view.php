...
<body>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="container mt-4 mb-5">
                    <caption>
                        <h4 class="text-center"> Others Details </h4>
                    </caption>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT others.id, others.name, others.code, others.price, others.type, MIN(others_images.image_path) AS image_path
                            FROM others
                            LEFT JOIN others_images ON others.id = others_images.furniture_id
                            GROUP BY others.id, others.name, others.code, others.price, others.type";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td data-label='Update'><a class='btn btn-primary' href='others_update.php?id=" . $row["id"] . "'>Update</a></td>";
    ...
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this item?")) {
            window.location.href = "others_delete.php?id=" + id;
        }
    }
