        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="container mt-4">
                    <caption>
                        <h4 class="text-center"> Office Room Review </h4>
                    </caption>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT office_reviews.id, office_reviews.product_id, office_reviews.user_name, office_reviews.review_text, office_reviews.rating, office_reviews.created_at, MIN(office_review_images.image_path) AS image_path FROM office_reviews LEFT JOIN office_review_images ON office_reviews.id = office_review_images.review_id GROUP BY office_reviews.id, office_reviews.product_id, office_reviews.user_name, office_reviews.review_text, office_reviews.rating";
    ...
    <script>
        ...
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this review?")) {
                window.location.href = "office_review_delete.php?id=" + id;
            }
        }
