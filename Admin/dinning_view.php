...
<body>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="container mt-4 mb-5">
                    <caption>
                        <h4 class="text-center"> Dining Details </h4>
                    </caption>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT dinning.id, dinning.name, dinning.code, dinning.price, dinning.type, MIN(dinning_images.image_path) AS image_path
                            FROM dinning
                            LEFT JOIN dinning_images ON dinning.id = dinning_images.furniture_id
                            GROUP BY dinning.id, dinning.name, dinning.code, dinning.price, dinning.type";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td data-label='Update'><a class='btn btn-primary' href='dinning_update.php?id=" . $row["id"] . "'>Update</a></td>";
    ...
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this item?")) {
            window.location.href = "dinning_delete.php?id=" + id;
        }
    }
