        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="container mt-4">
                    <caption>
                        <h4 class="text-center"> Living Room Review </h4>
                    </caption>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT living_reviews.id, living_reviews.product_id, living_reviews.user_name, living_reviews.review_text, living_reviews.rating, living_reviews.created_at, MIN(living_review_images.image_path) AS image_path FROM living_reviews LEFT JOIN living_review_images ON living_reviews.id = living_review_images.review_id GROUP BY living_reviews.id, living_reviews.product_id, living_reviews.user_name, living_reviews.review_text, living_reviews.rating";
    ...
    <script>
        ...
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this review?")) {
                window.location.href = "living_review_delete.php?id=" + id;
            }
        }
