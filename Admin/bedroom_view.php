...
<body>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="container mt-4 mb-5">
                    <caption>
                        <h4 class="text-center"> Bedroom Details </h4>
                    </caption>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT bedroom.id, bedroom.name, bedroom.code, bedroom.price, bedroom.type, MIN(bedroom_images.image_path) AS image_path
                            FROM bedroom
                            LEFT JOIN bedroom_images ON bedroom.id = bedroom_images.furniture_id
                            GROUP BY bedroom.id, bedroom.name, bedroom.code, bedroom.price, bedroom.type";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td data-label='Update'><a class='btn btn-primary' href='bedroom_update.php?id=" . $row["id"] . "'>Update</a></td>";
    ...
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this item?")) {
            window.location.href = "bedroom_delete.php?id=" + id;
        }
    }
