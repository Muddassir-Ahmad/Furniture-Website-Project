...
<body>
                ...
                <div class="container mt-4 mb-5">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT office.id, office.name, office.code, office.price, office.type, MIN(office_images.image_path) AS image_path
                            FROM office
                            LEFT JOIN office_images ON office.id = office_images.furniture_id
                            GROUP BY office.id, office.name, office.code, office.price, office.type";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td data-label='Update'><a class='btn btn-primary' href='office_update.php?id=" . $row["id"] . "'>Update</a></td>";
    ...
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this item?")) {
            window.location.href = "office_delete.php?id=" + id;
        }
    }
