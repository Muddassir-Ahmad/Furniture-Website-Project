...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_furniture_query = "INSERT INTO `reading`(`name`, `code`, `price`, `type`, `material`, `size`, `information`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt_furniture) {
        ...
        if ($stmt_furniture->execute()) {
            ...
            $insert_image_query = "INSERT INTO `reading_images`(`furniture_id`, `image_path`) VALUES (?, ?)";
            ...
            echo "<script>location.href='reading_upload.php'</script>";
        } else {
