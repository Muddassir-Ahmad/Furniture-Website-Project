        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="container mt-4">
                    <caption>
                        <h4 class="text-center"> Dining Room Review </h4>
                    </caption>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT dinning_reviews.id, dinning_reviews.product_id, dinning_reviews.user_name, dinning_reviews.review_text, dinning_reviews.rating, dinning_reviews.created_at, MIN(dinning_review_images.image_path) AS image_path FROM dinning_reviews LEFT JOIN dinning_review_images ON dinning_reviews.id = dinning_review_images.review_id GROUP BY dinning_reviews.id, dinning_reviews.product_id, dinning_reviews.user_name, dinning_reviews.review_text, dinning_reviews.rating";
    ...
    <script>
        ...
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this review?")) {
                window.location.href = "dining_review_delete.php?id=" + id;
            }
        }
