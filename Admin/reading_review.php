        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="container mt-4">
                    <caption>
                        <h4 class="text-center"> Reading Room Review </h4>
                    </caption>
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT reading_reviews.id, reading_reviews.product_id, reading_reviews.user_name, reading_reviews.review_text, reading_reviews.rating, reading_reviews.created_at, MIN(reading_review_images.image_path) AS image_path FROM reading_reviews LEFT JOIN reading_review_images ON reading_reviews.id = reading_review_images.review_id GROUP BY reading_reviews.id, reading_reviews.product_id, reading_reviews.user_name, reading_reviews.review_text, reading_reviews.rating";
    ...
    <script>
        ...
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this review?")) {
                window.location.href = "reading_review_delete.php?id=" + id;
            }
        }
