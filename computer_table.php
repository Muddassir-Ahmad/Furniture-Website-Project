...
<head>
    ...
    <title>Computer Table Collections - Ittadi Furniture</title>
...
<body>
    ...
    <main class="container mt-0">
        ...
        <h3 class="mb-4 text-center">Computer Table Collections</h3>
        <div class="row">
            <?php
            $allData = mysqli_query($conn, "SELECT reading.*, reading_images.image_path
                                            FROM reading
                                            LEFT JOIN reading_images ON reading.id = reading_images.furniture_id
                                            WHERE reading.type='Computer Table'");
            ...
            ?>
                ...
                <div class="col-6 col-md-3 mb-4">
                    <div class="card">
                        <a href="product_details.php?type=reading&id=<?php echo $product['id']; ?>">
