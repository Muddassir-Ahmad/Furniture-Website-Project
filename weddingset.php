...
<head>
    ...
    <title>Wedding Set Collections - Ittadi Furniture</title>
...
<body>
    ...
    <main class="container mt-4">
        ...
        <h3 class="mb-4 text-center">Wedding Set Collections</h3>
        <div class="row">
            <?php
            $allData = mysqli_query($conn, "SELECT others.*, others_images.image_path
                                            FROM others
                                            LEFT JOIN others_images ON others.id = others_images.furniture_id
                                            WHERE others.type='Wedding Set'");
            ...
            ?>
                ...
                <div class="col-6 col-md-3 mb-4">
                    <div class="card">
                        <a href="product_details.php?type=others&id=<?php echo $product['id']; ?>">
