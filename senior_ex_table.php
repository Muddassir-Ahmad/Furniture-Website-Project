...
<head>
    ...
    <title>Senior Ex-Table Collections - Ittadi Furniture</title>
...
<body>
    ...
    <main class="container mt-0">
        ...
        <h3 class="mb-4 text-center">Senior Executive Table Collections</h3>
        <div class="row">
            <?php
            $allData = mysqli_query($conn, "SELECT office.*, office_images.image_path
                                            ...
                                            WHERE office.type='Senior Ex Table'");
