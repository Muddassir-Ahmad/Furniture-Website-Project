...
if (isset($_GET['id'])) {
    ...
    $productData = mysqli_query($conn, "SELECT * FROM `reading` WHERE id = $productId");
    ...
    // Fetch the main image from furniture_images table (first image)
    $imageData = mysqli_query($conn, "SELECT * FROM `reading_images` WHERE furniture_id = $productId ORDER BY id ASC LIMIT 1");
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                ...
                <div class="mt-4">
                    ...
                    $imagesData = mysqli_query($conn, "SELECT * FROM `reading_images` WHERE furniture_id = $productId");
